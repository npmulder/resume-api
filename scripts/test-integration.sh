...
# Integration Test Runner Script with Docker
# This script runs integration tests using a PostgreSQL Docker container

set -e

echo "🧪 Resume API Integration Tests (Docker)"
echo "======================================"
...
CONTAINER_NAME="resume-api-integration-test-db"
...
if go test ./internal/integration/ -v -timeout=120s; then
    echo ""
...
echo "   • Profile: End-to-end API testing with database"
echo "   • Experiences: Filtering, pagination, date ranges"
echo "   • Skills: Categories, levels, featured skills"
echo "   • Achievements: Years, categories, impact metrics"
echo "   • Education: Types, statuses, credentials"
echo "   • Projects: Technologies, status filtering"
